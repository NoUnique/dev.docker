...
function fn_run_jupyter() {
    ...
    echo "Enable jupyter-vim-binding nbextension"
    docker-compose -f ${SCRIPT_DIR}/${COMPOSE_FNAME} -p ${COMPOSE_PROJECT_NAME} exec ${DEFAULT_SERVICE} jupyter nbextension enable vim_binding/vim_binding
